...
class SessionArgs:
    ...
    override_sdkconfig_items: dict[str, t.Any] = {}
    ...
    def _get_override_sdkconfig_files_items(self, override_sdkconfig_files: tuple[str]) -> dict:
        d = {}
    ...
    def _get_override_sdkconfig_items(self, override_sdkconfig_items: tuple[str]) -> dict:
        d = {}
    ...
    def _create_override_sdkconfig_merged_file(self, override_sdkconfig_merged_items) -> str | None:
